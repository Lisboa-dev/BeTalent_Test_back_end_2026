...
export class ProductSchema extends BaseModel {
  static $columns = ['createdAt', 'description', 'id', 'name', 'price', 'status', 'stock', 'updatedAt'] as const
...
export class TransactionSchema extends BaseModel {
  static $columns = ['cardLastNumbers', 'client', 'createdAt', 'externalId', 'gatewayId', 'id', 'idempotencyKey', 'status', 'updatedAt', 'value'] as const
